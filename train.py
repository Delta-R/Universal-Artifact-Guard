...
if __name__ == '__main__':
    ...
    val_opt = get_val_opt()
    # Dataset-gemini split (each val root must contain real/ and fake/ subfolders)
    val_data_root = ["Datasets-4000/val"]

    # Training data folders (can be a list of multiple directories per class)
    real_folders = ["Datasets-4000/train/real"]
    fake_folders = ["Datasets-4000/train/fake"]
